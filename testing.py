...
5 items had no tests:
    __main__
    __main__.display_current_state
    __main__.get_valid_guess
    __main__.initialize_game
    __main__.play_hangman
2 items passed all tests:
   3 tests in __main__.choose_topic_menu
   1 tests in __main__.update_display
4 tests in 7 items.
