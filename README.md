...
For my final project I wanted to make a game thats familiar and fun, which is why I decided on making the minigame hangman. To make the game more enjoyable I added muiltple topics that people could choose from would so they can have a theme for thier guesses. It started with a list of words for colors then I made one for animals and one for countires. Out of these 3 topics there are at least 10 words each that the user can guess. There are 6 attempts/guesses and with each wrong guess the another part of the hangman is revealed. Its a simple and engaging game that anyone can enjoy!
